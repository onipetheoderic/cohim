...
import { direct_labour } from '../datasheetTemplates/otherTemplates';
...
const DirectJob = (props) => {    
    const [road, setRoad] = useState(direct_labour);
 
    const [title, setTitle] = useState("direct labour used");
    const [location, setLocation] = useState({});
    const [type, setType] = useState("direct_labour");
