...
import { weatherCondition } from '../datasheetTemplates/otherTemplates';

import UnderscoreFormatter from '../helpers/underscoreFormatter';
import ZeroChecker from '../helpers/zeroCheckUnit';

import {Toast} from 'native-base';


const UploadWeatherCondition = (props) => {    
    const [road, setRoad] = useState(weatherCondition);
 
    const [title, setTitle] = useState("Weather condition");
    const [location, setLocation] = useState({});
    const [type, setType] = useState("weather_condition");
...
export default UploadWeatherCondition;
